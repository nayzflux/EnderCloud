...
for `AGENT_RUNTIME_HOST_DIRECTORY`; see [the agent guide](AGENT.md#runtime-materialization).
...
See [the dashboard guide](../dashboard/README.md) for route and component details.
...
See [the group reference](../groups/GROUP.md) and
[the template reference](../templates/VARIANT.md).
...
The standard full validation is documented in [Tests](TEST.md).
