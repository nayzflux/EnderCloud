---
title: Minigame plugin integration
description: Contracts between Paper minigames, Velocity, sessions, team assignment, and results.
---
...
See [the group reference](/docs/configure/groups) for every field.
