---
title: Orchestrator
description: Startup, control loops, APIs, durable state ownership, and environment variables.
---
...
See [Environment configuration](/docs/configure/environment) for removed names and [Agent](/docs/configure/agent) for the
