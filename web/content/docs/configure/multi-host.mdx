...
description: Placement, networking, recovery, and maintenance across distributed Docker hosts.
---
...
See [Agent](/docs/configure/agent) for the complete variable reference and [Tests](/docs/develop/testing) for the local smoke
test.
