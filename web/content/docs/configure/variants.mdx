---
title: Template layers and variants
description: Ordered file layers, runtime settings, revision identity, and immutable server material.
---
...
See [the group reference](/docs/configure/groups) for traffic and capacity policy.
