...
description: Routes, data flow, cluster views, mock data, and validation for the operations console.
---
...
[`docs/ENVIRONMENT.md`](/docs/configure/environment).
...
See [the project test reference](/docs/develop/testing) for the full repository validation sequence.
