---
title: Core concepts
description: Groups, variants, instances, sessions, and lifecycle vocabulary used across EnderCloud.
---
...
startup. See [the group reference](/docs/configure/groups).
...
See [the template and variant reference](/docs/configure/variants).
...
work that is already late. See [the timeout reference](/docs/configure/timeouts).
