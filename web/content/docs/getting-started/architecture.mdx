---
title: Architecture
description: Control-plane boundaries, durable state, request flows, and recovery behavior.
---
...
See [Concepts](/docs/getting-started/concepts) for the instance and session state machines.
...
[Multi-host execution](/docs/configure/multi-host) for deployment details.
